...
namespace KeyboardScancode
{
    public static class statics
    {
        ...
        public static void SendKeyDown(ScanCodeShort scanCode)
        {
            INPUT[] InputData = new INPUT[1];

            InputData[0].type = 1;
            InputData[0].U.ki.wScan = scanCode;
            InputData[0].U.ki.dwFlags = KEYEVENTF.SCANCODE;

            SendInput(1, InputData, Marshal.SizeOf(typeof(INPUT)));
        }
        public static void SendKeyUp(ScanCodeShort scanCode)
        {
            INPUT[] InputData = new INPUT[1];

            InputData[0].type = 1;
            InputData[0].U.ki.wScan = scanCode;
            InputData[0].U.ki.dwFlags = KEYEVENTF.SCANCODE | KEYEVENTF.KEYUP;
